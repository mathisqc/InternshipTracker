...
def register(
    ...
    """
        ...
        - Renvoie une réponse HTTP en cas de succès ou d'échec.
    """
...
# Pour des raisons de sécurité, il est recommandé de stocker la clé secrète dans une variable d'environnement
# SECRET_KEY = os.getenv("SECRET_KEY", "default_secret_key")
SECRET_KEY = "la_clé_secrète"
ALGORITHM = "HS256"
...
@app.get("/set_all_passwords/{new_password}") # Uniquement pour les tests, ne pas utiliser en production
